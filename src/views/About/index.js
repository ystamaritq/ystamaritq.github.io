		...
		<Container fluid className="p-5">
			<MDBRow className="d-flex justify-content-center flex-wrap flex-row">
				<MDBCol className="col-lg-8 col-md-6 col-sm-12">
					<MDBCard className="bg-light bg-border">
						<MDBCardImage
							className="mb-0 py-3 rounded-circle z-depth-1 img-fluid col-sm-12 mx-auto d-lg-flex d-md-flex d-sm-flex"
							src={pic}
							md="4"
							alt="me"
							style={{ width: "22em" }}
						...
						<MDBCardBody cascade className="text-center">
							...
							<MDBCardText className="text-justify custom-p-color">
